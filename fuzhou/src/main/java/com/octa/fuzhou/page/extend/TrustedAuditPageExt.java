...
import com.octa.fuzhou.page.TrustedAuditPage;
...
//		listTabPageJumpContainer = new Container(getListPageJumpContainer());
    ...
    * click msg ok button 
    */
	public TrustedAuditPageExt clickMsgOkButton() throws Exception{
		return click(getMsgOkButton(), TrustedAuditPageExt.class);
	}
