...
public class WhiteListPage extends BasePage {
	...
	private WebElement whiteListContainer;
	//container内的多选框
	...
	//文件（数据）哈希
	private By wlFileDataNum = By.cssSelector(".clearfix .wl-filedata-num");
	//文件路径
	private By wlFileNameHint = By.cssSelector(".clearfix .wl-filename-hint");
	//IP
	...
	public WebElement getWhiteListContainer() {
	...
	public By getWlFileDataNum() {
		return wlFileDataNum;
	}

	public By getWlFileNameHint() {
		return wlFileNameHint;
	}
